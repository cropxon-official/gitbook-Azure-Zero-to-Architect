...
* [Azure Architecture with .NET](README.md)
  * [PART I — Azure & Cloud First Principles](azure-architecture-with-.net/part-i-azure-and-cloud-first-principles.md)
  * [PART II — Compute Architecture](azure-architecture-with-.net/part-ii-compute-architecture/README.md)
    * [VM vs PaaS vs Containers](azure-architecture-with-.net/part-ii-compute-architecture/vm-vs-paas-vs-containers.md)
